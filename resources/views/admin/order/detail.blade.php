                ...
                <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <strong class="text-success">{{ number_format($item->price * $item->quantity)
                                            }}đ</strong>
                                    </td>
                    ...
                    <div class="col-lg-3  ">
                        ...
                        <section class="mb-5">
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                <span class="fw-semibold">Payment:</span><span class="badge bg-label-primary me-1">Thanh
                                    toán khi nhận hàng</span>
                            </div>
                            @else
                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                <span class="fw-semibold">Payment:</span><span class="badge bg-label-success me-1">Thanh
                                    toán online</span>
                            </div>
                            @endif
                        </section>
                        ...
                        <form action="{{route('dashboard.order.confirm-order',$customerInfo->id)}}" method="post">
                            @method('put')
                            @csrf
                            <button class="btn btn-dark w-100"><span>Xác nhận đơn
                                    hàng</span></button>
                        </form>
