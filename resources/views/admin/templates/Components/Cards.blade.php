    ...
    <div class="row mb-5">
        <div class="col-md">
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img class="card-img card-img-left" src="{{ asset('admin/assets') }}/img/elements/12.jpg"
                            alt="Card image" />
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
        ...
        <div class="col-md">
            <div class="card mb-3">
                <div class="row g-0">
                    ...
                    <div class="col-md-4">
                        <img class="card-img card-img-right" src="{{ asset('admin/assets') }}/img/elements/17.jpg"
                            alt="Card image" />
                    </div>
                </div>
            </div>
