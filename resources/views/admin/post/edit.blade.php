...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <x-alert />
                <x-header-table tableName="Cập nhật  {{ $moduleName }}" link="dashboard.post.index"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                <div class="upload__box d-flex justify-content-center flex-column align-items-center gap-3">
                                    ...
                                    <input type="text" name="cover" value="{{ $post->cover }}" hidden>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <select id="select-multiple" class="@error('tags') is-invalid @enderror" multiple
                                    ...
                                    @foreach (getAllTags() as $tag)
                                        <option
                                            {{ strpos(old('tags') ?? $post->tags, $tag->name) !== false ? 'selected' : '' }}
